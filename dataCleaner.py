...
df_loopdata = df_loopdata.drop("occupancy","status","dqflags")
...
df_third.withColumn("locationtext", regexp_replace(df_third["locationtext"], " at ", ""))
df_third.withColumn("locationtext", regexp_replace(df_third["locationtext"], "I-205", ""))
df_third.withColumn("locationtext", regexp_replace(df_third["locationtext"], " Blvd", ""))
df_third.withColumn("locationtext", regexp_replace(df_third["locationtext"], " Cr", " Creek")) # expand CR to Creek
# Show the result
df_third.show()
df_third = df_third.na.drop('any')
df_third.show()
# Convert to CSV
